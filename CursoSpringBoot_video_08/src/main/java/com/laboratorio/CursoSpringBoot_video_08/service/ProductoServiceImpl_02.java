package com.laboratorio.CursoSpringBoot_video_08.service;
...
@Service
@Order(2)
public class ProductoServiceImpl_02 implements
            ProductoService{
    ...
    public String delete(Integer id) {
        ...
        return "Impl_02: Se ha eliminado el producto: "+productoAEliminar.getNombre();
    }
}
